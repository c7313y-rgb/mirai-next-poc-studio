...
const Icon = {
  ...
  survey: (
    ...
    >
      ...
      <path d="M8 8l1.5 1.5L12 7M8 14l1.5 1.5L12 13M14 8h2M14 14h2" />
    </svg>
  ),
};
...
export default function StudentApp({ user, route, onLogout }) {
  ...
  const nav = [
    { to: '/', label: 'ホーム', icon: '▦' },
    { to: '/lessons', label: '授業に参加する', icon: '▷' },
    { to: '/themes', label: '探究テーマ', icon: '✦' },
  ...
  return (
    <header className="student-head grid-paper">
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        {back && (
          <a href={'#' + back} className="btn ghost small" style={{ marginLeft: -12 }}>
            戻る
          </a>
        )}
